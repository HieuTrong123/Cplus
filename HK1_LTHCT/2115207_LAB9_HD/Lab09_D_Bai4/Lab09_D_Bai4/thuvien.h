...
void Chen_SV(const char *maSV, const char* hoLot, const char* ten, const char* gioiTinh, unsigned int namSinh,
	const char* queQuan, const char* lop, double diem, SinhVien* a, int& n)
{
	if (n < MAX)
	{
